                ...
                <div className="flex flex-col justify-center items-center gap-3 w-full max-w-80">
                    ...
                    <form className="flex flex-col gap-2 w-full" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <label className="input input-bordered w-full flex items-center gap-2">
                            ...
                            <input type="username" className="grow" placeholder="Username" {...register('username', { required: 'username is required' })} />
                        </label>
                        ...
                        <div className="flex justify-between items-center w-full px-2">
                            <span className="text-info">Already have an account?</span>
                        ...
                        <div className="flex justify-center w-full mt-2">
                            <button type="submit" className="btn btn-primary w-32" disabled={loading}>
