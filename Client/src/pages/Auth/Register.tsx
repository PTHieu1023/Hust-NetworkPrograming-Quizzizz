        ...
        <div className="flex justify-center items-center w-full h-full">
            <div className="flex justify-center items-center max-w-xl w-full h-fit py-8 mx-4 bg-base-300 rounded-box shadow-xl">
                <div className="flex flex-col justify-center items-center gap-3 w-full max-w-80">
                    <h2 className="text-2xl text-secondary">Register screen</h2>
                    ...
                    <div className="flex justify-between items-center w-full px-2">
                        ...
                        <Link to="/auth/login" className="text-secondary hover:underline hover:opacity-50">
                            Login here
                        </Link>
                    </div>
                    <button className="btn btn-outline btn-success w-32 mt-4">Register</button>
                </div>
            </div>
        </div>
    )
