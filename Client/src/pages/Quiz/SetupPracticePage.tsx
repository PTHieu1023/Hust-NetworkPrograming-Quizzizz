        ...
        <div className="flex flex-wrap justify-center max-w-7xl w-full p-4">
            <div className="w-full md:w-1/2 p-4">
                <div className="flex justify-center min-h-64 p-8 rounded-lg bg-base-100">
                    <form
                        className="flex flex-col gap-4 justify-center items-center w-full max-w-80"
                        onSubmit={() => {}}
                    >
            ...
            <div className="w-full md:w-1/2 p-4">
                <div className="flex justify-center items-center min-h-64 p-8 rounded-lg bg-base-100">
                    Recent activity
                </div>
            </div>
        </div>
